...
import mulan.resampling.MLROS;
import weka.core.Utils;

public class MLROSExecuter {
    ...
    public static void main(String[] args) {
        try {
    		...
    		MLROS mlros = new MLROS(originalDataset, directory + xmlFilename);
    		MultiLabelInstances resampledDataset = mlros.resample();
    		System.out.println("New number of instances: " + resampledDataset.getNumInstances());
    		System.out.println("Writing result dataset...");
    		BufferedWriter writer = new BufferedWriter(new FileWriter(directory + "MLROS-" + arffFilename));
