...
import mulan.resampling.REMEDIAL;
import weka.core.Utils;

public class REMEDIALExecuter {
    ...
    public static void main(String[] args) {
        try {
    		...
    		REMEDIAL remedial = new REMEDIAL(originalDataset, directory + xmlFilename);
    		MultiLabelInstances resampledDataset = remedial.resample();
    		System.out.println("New number of instances: " + resampledDataset.getNumInstances());
    		System.out.println("Writing result dataset...");
    		BufferedWriter writer = new BufferedWriter(new FileWriter(directory + "REMEDIAL-" + arffFilename));
