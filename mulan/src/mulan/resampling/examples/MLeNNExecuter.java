...
import mulan.resampling.MLeNN;
import weka.core.Utils;

public class MLeNNExecuter {
    ...
    public static void main(String[] args) {
        try {
    		...
    		MLeNN mleNN = new MLeNN(originalDataset, directory + xmlFilename);
    		MultiLabelInstances resampledDataset = mleNN.resample();
    		System.out.println("New number of instances: " + resampledDataset.getNumInstances());
    		System.out.println("Writing result dataset...");
    		BufferedWriter writer = new BufferedWriter(new FileWriter(directory + "MLeNN-" + arffFilename));
