...
import mulan.resampling.MLSMOTE;
import weka.core.Utils;

public class MLSMOTEExecuter {
    ...
    public static void main(String[] args) {
        try {
    		...
    		MLSMOTE mlsmote = new MLSMOTE(originalDataset, directory + xmlFilename);
    		MultiLabelInstances resampledDataset = mlsmote.resample();
    		System.out.println("New number of instances: " + resampledDataset.getNumInstances());
    		System.out.println("Writing result dataset...");
    		BufferedWriter writer = new BufferedWriter(new FileWriter(directory + "MLSMOTE-" + arffFilename));
