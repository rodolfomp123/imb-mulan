...
import mulan.resampling.MLRUS;
import weka.core.Utils;

public class MLRUSExecuter {
    ...
    public static void main(String[] args) {
        try {
    		...
    		MLRUS mlrus = new MLRUS(originalDataset, directory + xmlFilename);
    		MultiLabelInstances resampledDataset = mlrus.resample();
    		System.out.println("New number of instances: " + resampledDataset.getNumInstances());
    		System.out.println("Writing result dataset...");
    		BufferedWriter writer = new BufferedWriter(new FileWriter(directory + "MLRUS-" + arffFilename));
