...
import mulan.resampling.LPRUS;
import weka.core.Utils;

public class LPRUSExecuter {
    ...
    public static void main(String[] args) {
        try {
    		...
    		LPRUS lprus = new LPRUS(originalDataset, directory + xmlFilename);
    		MultiLabelInstances resampledDataset = lprus.resample();
    		System.out.println("New number of instances: " + resampledDataset.getNumInstances());
    		System.out.println("Writing result dataset...");
    		BufferedWriter writer = new BufferedWriter(new FileWriter(directory + "LPRUS-" + arffFilename));
