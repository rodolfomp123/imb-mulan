...
import mulan.resampling.MLBFO;
import weka.core.Utils;

public class MLBFOExecuter {
    ...
    public static void main(String[] args) {
        try {
    		...
    		MLBFO mlbfo = new MLBFO(originalDataset, directory + xmlFilename);
    		MultiLabelInstances resampledDataset = mlbfo.resample();
    		System.out.println("New number of instances: " + resampledDataset.getNumInstances());
    		System.out.println("Writing result dataset...");
    		BufferedWriter writer = new BufferedWriter(new FileWriter(directory + "MLBFO-" + arffFilename));
