...
//      String relation_name = data.getDataSet().relationName();
...
//              String method_name = learner.getClass().getName();
//              PrintWriter writer = new PrintWriter("/home/claudiatrevizanss/Folds/" 
//                						+ method_name + " Fold " + (i + 1) + " " + relation_name, "UTF-8");
